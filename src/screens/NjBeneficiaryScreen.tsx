...
export const NjBeneficiaryScreen = () => {
  ...
  const addBeneficiary = () => {
    const payload = {
      ...
      account_number: accountNumber,
      bank_id: bankCode,
      currency: displayedCurrencyTo.substring(0,displayedCurrencyTo.indexOf("(")).trim(),
      deposit: 1
    }
  ...
  return (
    <SafeAreaView style={globalStyles.container} forceInset={{ top: "always" }}>
      ...
      >
        ...
        <View style={[globalStyles.inputBox, {marginTop: 50, marginBottom: 20}]}>
          <DropDownPicker
            schema={{
        ...
        <View style={[globalStyles.inputBox,{marginBottom: 20}]}>
          ...
          <TouchableOpacity
            style={[globalStyles.button, { marginBottom: -10, marginTop: 50, backgroundColor: "#000000" }]}
            onPress={() => {
              addBeneficiary();
              // v
            }}
